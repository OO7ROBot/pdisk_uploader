...
CHANNEL = environ.get('CHANNEL', 'Housefull Links)
...
async def remove_username(new_List):
    for i in new_List:
        if('@' in i or 't.me' in i or 'https://t.me/housefull_links' in i or 'https://cdx_bots' in i or 'telegra.ph' in i):
            new_List.remove(i)
    return new_List
...
async def addFooter(str):
    footer = """
━━━━━━━━━━━━━━━
⦿ Made With♥️BY @Cdx_botS
━━━━━━━━━━━━━━━
✪ »JOIN CHANNEL ➡️ t.me/housefull_links + CHANNEL
    return str + footer
